...
class myImgTableViewCell: UITableViewCell {

    static let identifier: String = "myImgTableViewCell"
    ...
    func configureConstraints() {
        NSLayoutConstraint.activate([
            ...
            stickerImageView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -10),
            
            dateTimeLabel.trailingAnchor.constraint(equalTo: stickerImageView.leadingAnchor, constant: 0),
